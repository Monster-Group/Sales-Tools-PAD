		...
		return {
			...
			link: function link($scope, $elements, $attrs, controllers) {
				...
				var getCityList = function getCityList() {
					...
					try {
						for (var _iterator = $rootScope.enumData.regionList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				...
				$scope.mobileChange = function () {
					...
					appApi.listOrderByBack($scope.productModel.mobile, function (d) {
						console.log(d);
